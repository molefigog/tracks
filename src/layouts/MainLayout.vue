<template>
    <q-layout view="hHh LpR lfr">
        ...
        <template v-if="$auth.isLoggedIn">
            ...
            <q-header elevated >
                <q-toolbar class="  ">
                    ...
                    <q-btn flat @click="toggleLeftDrawer" round dense icon="fas fa-bars"></q-btn>
                    ...
                    <q-btn-dropdown no-caps stretch unelevated icon="fas fa-user">
                        <q-list dense style="min-width:200px">
                            <q-item  clickable v-ripple to="/account">
                                <q-item-section avatar>
                                    <q-avatar icon="fas fa-user"></q-avatar>
                                </q-item-section>
                                <q-item-section>
                            ...
                            <q-item  clickable v-ripple @click="startLogout()">
                                <q-item-section avatar>
                                    <q-avatar icon="fas fa-sign-out-alt"></q-avatar>
                                </q-item-section>
                                <q-item-section>
            ...
            <q-drawer v-model="leftDrawer" show-if-above  :width="250" :breakpoint="500" bordered  elevated :mini="leftDrawerMini">
                <q-scroll-area class="fit   ">
                    ...
                    <q-img class="img-fluid" :src="$utils.setImgUrl3($auth.userPhoto)">
                    ...
                    <q-menu auto-close touch-position>
                        <q-list dense style="min-width:100px">
                            <q-item exact clickable v-ripple to="/account">
                                <q-item-section avatar>
                                    <q-avatar icon="fas fa-user"></q-avatar>
                                </q-item-section>
                                <q-item-section>
                    ...
                    <div v-show="!leftDrawerMini" class="text-bold text-center text-capitalize q-pa-sm">
                       Hi  {{ $auth.userName }}  Balance R{{ $auth.userBalance }}
        ...
        <q-drawer :no-swipe-open="!drawerComponentFile" side="right" v-model="rightDrawer.showDrawer" :width="rightDrawer.width" :breakpoint="500" overlay  elevated>
            ...
            <q-btn style="position:absolute;top:10px;right:10px" unelevated dense round color="grey-1" text-color="grey" icon="fas fa-times-circle" @click="rightDrawer.showDrawer = false"></q-btn>
        </q-drawer>
        ...
        <q-dialog
            ...
            >
            <q-card class="q-pa-md" :style="{ width: pageDialog.width, maxWidth: pageDialog.maxWidth }">
                <component
                ...
                />
                <q-btn style="position: absolute; top: 20px; right: 20px" v-if="pageDialog.closeBtn" icon="fas fa-times-circle" color="grey" flat round dense v-close-popup />
            ...
            <q-dialog v-model="errorDialog" position="top">
                <q-card style="min-width: 300px; max-width: 95vw">
                    <q-card-section class="row items-center align-start">
                        ...
                        <q-space />
                        <q-btn icon="fas fa-times-circle" flat round dense v-close-popup />
                        </q-card-section>
                    </q-card>
                </q-dialog>
            </q-layout>
