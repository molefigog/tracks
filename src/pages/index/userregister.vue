                            ...
                            <div  class="col-md-4 col-12 comp-grid" >
                                <div class="">
                                    <div>
                                        ...
                                        <q-btn     :rounded="false"  no-caps  unelevated    color="accent" icon="fas fa-user" to="/"> Login</q-btn>
                                    </div>
                                </div>
                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		pageData: { // use to set formData default values from another page
			type: Object,
			default: () => ({
				name: "", email: "", password: "", confirm_password: "", mobile_number: "NULL", avatar: "", otp_code: "NULL", otp_date: "NULL", 
			})
		},
	});
