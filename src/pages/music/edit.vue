                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <div class="q-mb-sm">
                                                        <q-uploader-input show-uploaded-files :max-files="1" :max-file-size="3" accept=".jpg,.png,.gif,.jpeg" :multiple="false" delete-icon="fas fa-times" style="width:100%" label="Choose files or drop files here" upload-path="fileuploader/upload/image" v-model="formData.image"  ></q-uploader-input>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <div class="q-mb-sm">
                                                        <q-uploader-input show-uploaded-files :max-files="1" :max-file-size="13" accept=".mp3,.mp4,.webm,.wav,.avi,.mpg,.mpeg" :multiple="false" delete-icon="fas fa-times" style="width:100%" label="Choose files or drop files here" upload-path="fileuploader/upload/file" v-model="formData.file"  ></q-uploader-input>
                                                        <!-- <small class="q-pa-sm text-negative"></small> -->
                                                    </div>
                                                </div>
                                            </div>
