                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/music/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="fas fa-angle-left" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/music"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.musiclistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/music/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                    </q-td>
                                    ...
                                    <q-td  key="image" :props="props">
                                        <image-viewer image-size="small" image-preview-size="large" :src="props.row.image" width="50px" height="50px" :num-display="1">
                                        </image-viewer>
                                    </q-td>
                                    ...
                                    <q-td key="btnactions" :props="props" auto-width>
                                        <div class="row q-col-gutter-xs justify-end">
                                            <q-btn icon="fas fa-bars" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/music/view/${props.row.id}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="fas fa-eye"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/music/edit/${props.row.id}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="fas fa-edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>Edit</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.id)">
                                                            <q-item-section>
                                                                <q-icon color="negative" size="sm" name="fas fa-trash"></q-icon>
                                                            </q-item-section>
                                ...
                                <div  v-show="pageReady">
                                    <div class="row items-center justify-between">
                                        <div class="row items-center q-col-gutter-md">
                                            <div>
                                                <q-btn round flat   no-caps  unelevated   color="negative" @click="deleteItem(selectedItems)" v-if="selectedItems.length" icon="fas fa-trash" class="q-my-xs" title="Delete Selected">
