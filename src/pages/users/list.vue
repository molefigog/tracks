                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="fas fa-angle-left" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/users"></q-breadcrumbs-el>
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="avatar" :props="props">
                                        <image-viewer image-size="small" image-preview-size="large" :src="props.row.avatar" width="50px" height="50px" :num-display="1">
                                        </image-viewer>
                                    </q-td>
                                    <q-td  key="facebook_id" :props="props">
                                        {{ props.row.facebook_id }}
                                    </q-td>
                                    <q-td  key="otp_code" :props="props">
                                        {{ props.row.otp_code }}
                                    </q-td>
                                    <q-td  key="otp_date" :props="props">
                                        {{ props.row.otp_date }}
                                    </q-td>
